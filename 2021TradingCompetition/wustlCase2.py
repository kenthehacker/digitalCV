        ...
        if kind == "pnl_msg":
            ...
            if fill_msg.order_side == pb.FillMessageSide.BUY:
                ...
                if (vol!=-9):
                    ...
                    print("DIICCC "+str(self.delta)+ "FQ "+ str(fillQty)+" defS " + str(self.defaultSize) +" GK "+ str(gk.delta(fillFlag,fillStrike, self.underlying_price,time_to_expiry, self.rfr,vol)))
