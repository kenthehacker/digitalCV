...
int main (int argc, char* argv[])
{
    ...
    struct timeval start, end; //<- homemade 
    long sec, micro_sec;
    ...
    micro_sec = ((sec * 1000000) + end.tv_usec) - (start.tv_usec);
    printf("MMAP took %ld seconds %ld micro seconds \n", sec, micro_sec);
    ...
    sec = (end.tv_sec - start.tv_sec);
    micro_sec = ((sec * 1000000) + end.tv_usec) - (start.tv_usec);
    printf("MATRIX MULT took %ld seconds %ld micro seconds \n", sec, micro_sec);
